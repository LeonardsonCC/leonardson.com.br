    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="https://leonardson.wtf/og.png"
        />
      </Head>
      <ThemeProvider theme={theme ? darkTheme : lightTheme}>
        ...
        <MainTheme>
          <Container>
            <Header>
              <h1>Olá!</h1>
              <h4>Me chamo Leonardson, e atualmente sou desenvolvedor WEB!</h4>
              <br />
              <SocialMedia>
                <a
                  id="github"
                ...
                <a
                  id="instagram"
                  href="https://www.instagram.com/LeonardsonCC/"
                  target="__blank"
                >
                  <Icon
                    role="img"
            ...
            <Info id="Info">
              ...
              <div className="Text">
                <h2>Sobre mim</h2>
                <p>
                  Tenho {yearsOld} anos, estou cursando Ciência da Computação na
                  Unisul (Universidade do Sul de Santa Catarina) e trabalho com
                  desenvolvimento a aproximadamente 1 ano.
                  <br /> <br />
                  Iniciei na programação aos 13 anos, tentando fazer <i>
                    mods
                  </i>{" "}
                  para jogos utilizando Java. Aos 16 iniciei um curso Técnico em
                  Informática no IFSC (Instituto Federal de Santa Catarina) onde
                  me formei em 2018.
                </p>
              </div>
            </Info>
